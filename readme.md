...
- [example-based photometric stereo: shape reconstruction with general, varying brdfs 📄](http://grail.cs.washington.edu/projects/sam/HertzmannSeitzPAMI2005.pdf)
  - paper discusses how you can reconstruct an objects 3d shape just by analyzing how light reflects off an object's surface 
  – picture examples [here](http://grail.cs.washington.edu/projects/sam/).
